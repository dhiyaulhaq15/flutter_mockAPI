...
// import 'login_page.dart'; // Komentar ini bisa dihapus karena sudah diimpor di atas

// Widget utama untuk halaman Admin, menggunakan StatefulWidget karena ada proses login dan logout
class AdminPage extends StatefulWidget {
  const AdminPage({super.key}); // Konstruktor dengan key opsional

  @override
  State<AdminPage> createState() => _AdminPageState(); // Membuat state dari AdminPage
}

// State dari halaman Admin
class _AdminPageState extends State<AdminPage> {
  ...
  Future<void> _checkLogin() async {
    ...
    // Kalau belum login atau bukan role 'admin', arahkan ke halaman login
  ...
  Widget build(BuildContext context) {
    return Scaffold( // Scaffold adalah struktur dasar halaman Flutter
      appBar: AppBar( // AppBar di bagian atas halaman
        title: const Text('Halaman Admin'), // Judul halaman
      ...
      body: const Center( // Bagian isi halaman
        child: Text('Selamat datang, Admin!'), // Teks sambutan untuk admin
      ),
    );
  }
}
